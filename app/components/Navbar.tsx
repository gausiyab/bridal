...
export default function Navbar() {
    ...
    return(
        <header className="mb-6 border-b fixed w-full z-30 bg-neutral-400 h-12 ">
            <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl mt-1">
                <Link href="/">
               <h2 className="text-xl font-bold">Mahira <span className="text-white">Couture</span></h2>
                </Link>
